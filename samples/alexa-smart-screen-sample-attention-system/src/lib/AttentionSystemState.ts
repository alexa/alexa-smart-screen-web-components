...
export enum AttentionSystemState {
  ...
  SPEAKING = 'SPEAKING',
  /// Attention System should display this state right after DND is enabled, or at the end of an Alexa Interaction if DND is enabled.
  DO_NOT_DISTURB_ENABLED = 'DO NOT DISTURB ENABLED',
  /// Attention System should display this state right after DND is disabled.
  DO_NOT_DISTURB_DISABLED = 'DO NOT DISTURB DISABLED'
}
